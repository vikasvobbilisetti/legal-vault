...
public class AddClient extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        ImageView backwardArrow = view.findViewById(R.id.backArrow_2);
        TextView add = view.findViewById(R.id.add_client);
        TextView skip = view.findViewById(R.id.skip_3);

        backwardArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navController = Navigation.findNavController(view);
                navController.navigate(R.id.action_addClient_to_addPartner);
            }
        });
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController = Navigation.findNavController(view);
                navController.navigate(R.id.action_addClient_to_clientAddition);
            }
        });
