...
public class AddEmployee extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        ImageView forwardArrow = view.findViewById(R.id.forwardArrow_1);
        TextView add = view.findViewById(R.id.add_employee);
        TextView skip = view.findViewById(R.id.skip_1);

        forwardArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navController = Navigation.findNavController(view);
                navController.navigate(R.id.action_addEmployee_to_addPartner);
            }
        });
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController = Navigation.findNavController(view);
                navController.navigate(R.id.action_addEmployee_to_employeeAddition);
            }
        });
