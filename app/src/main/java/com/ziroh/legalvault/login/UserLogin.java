...
public class UserLogin extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView createAccount = view.findViewById(R.id.create_an_account);
        TextView nextButton = view.findViewById(R.id.next4);
        TextView forgotPass = view.findViewById(R.id.forgot_pass);
        TextView username = view.findViewById(R.id.username);
        TextView password = view.findViewById(R.id.password);
        TextView incorrectPass = view.findViewById(R.id.incorrect_pass);
        TextView incorrectUser = view.findViewById(R.id.incorrect_username);

        createAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navController = Navigation.findNavController(view);
                navController.navigate(R.id.action_userLogin_to_userExistsLogin);
            }
        });
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (usern.equals("admin")) {
                    incorrectUser.setVisibility(View.INVISIBLE);
                    if (pass.equals("admin")) {
                        incorrectPass.setVisibility(View.INVISIBLE);
                        navController = Navigation.findNavController(view);
                        navController.navigate(R.id.action_userLogin_to_addEmployee);
                    } else {
                        incorrectPass.setVisibility(View.VISIBLE);
                    }
                } else {
                    incorrectUser.setVisibility(View.VISIBLE);
                }
        ...
        forgotPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController = Navigation.findNavController(view);
                navController.navigate(R.id.action_userLogin_to_userLoginResetPassword);
            }
        });
    }
}